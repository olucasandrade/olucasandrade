...
**_Eu juro que não é por conta da fofura do Mascote…_**
...
_Disclaimer: Estou assumindo nesse passo a passo que o leitor já criou um projeto em Go, seja ele simples, seja uma API mais complexa, então vou poupar algumas explicações mais básicas._
