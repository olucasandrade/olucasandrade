...
AWS Lambda is a [*serverless*](https://www.redhat.com/pt/topics/cloud-native-apps/what-is-serverless) computing service where, very briefly, the user can execute code blocks in the cloud. But in reality, the service can be used for infinite purposes.
