...
_Note: Both git pull and git push are accompanied by the origin command + the name of your branch, which is a somewhat more complex subject and main theme of another article. For now, use the commands accompanied by "origin master"._
...
_"But what would Github be? Isn't it the same thing as git then?"_
