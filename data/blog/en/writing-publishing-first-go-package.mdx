...
**_I swear it's not because of the cuteness of the Mascot…_**
...
_Disclaimer: I'm assuming in this step-by-step that the reader has already created a project in Go, whether it's simple or a more complex API, so I'll spare some more basic explanations._
